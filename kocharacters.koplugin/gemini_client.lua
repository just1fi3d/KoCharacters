...
GeminiClient.MODELS = {
    {
        ...
        name         = "3.1 Flash-Lite",
        description  = "Most cost-efficient; best for high-volume extraction. Free tier available, but preview capacity limits can cause 503 errors under high demand.",
        input_price  = 0.125,
        output_price = 0.750,
        free_tier    = true,
        preview      = true,
    ...
    },
    {
        ...
        name         = "2.5 Flash-Lite",
        description  = "Stable model — much lower risk of 503 errors than any preview. Cheapest paid option. Quality comparable to the 3.1 Flash-Lite preview. Requires a billing-enabled API key.",
        input_price  = 0.050,
        output_price = 0.200,
        free_tier    = false,
        preview      = false,
...
- For defining_moments: only capture a "One-Way Door" event — one after which the character's status, body, or knowledge is permanently altered.
    ...
    Exclude: combat without consequence, travel, standard dialogue, temporary moods, recurring events, and repeated instances of the same broad type of experience or situation (if the list already records this character being subjected to this type of experience, additional instances are not a new One-Way Door unless they produce a fundamentally new permanent outcome not captured by the existing entry).
  Each entry must be one sentence in past tense. Before adding a new entry, ask: (1) Is this a "One-Way Door" — is the character's status, body, or knowledge permanently altered? (2) Is this a genuinely novel category of event not yet captured in the existing entries? Only append if both answers are yes. Append only; never remove existing entries.
